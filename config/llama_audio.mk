...
ALARM_PATH := vendor/llama/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/llama/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/llama/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/llama/prebuilt/common/media/audio/ui
